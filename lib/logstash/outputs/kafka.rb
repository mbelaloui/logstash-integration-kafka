...
class LogStash::Outputs::Kafka < LogStash::Outputs::Base
  ...
  # present in both is emitted twice. Entries with an empty key or nil value, and non-scalar values, are skipped.
  ...
  def add_dynamic_message_headers(record, event)
    ...
    warn_once("Failed to add dynamic message headers; event sent without them",
